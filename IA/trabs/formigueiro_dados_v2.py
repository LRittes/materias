...
def pickItem(ant: Ant, item, k1, alfa):
    ...
    problaly = math.pow(k1/(k1 + f(len(itemsAround), itemsAround, item, alfa)), 2)
...
if __name__ == '__main__':
    ...
    threads = []
    for ant in ants:
        thread = Thread(target=initAnt, args=(ant, 0.0001, 0.001, 10))
    ...
    # vasilha = [[(data[0]['x'],data[0]['y'],data[0]['rot']),(data[1]['x'],data[1]['y'],data[1]['rot']),(data[2]['x'],data[2]['y'],data[2]['rot'])],
    #            ['x',(data[3]['x'],data[3]['y'],data[3]['rot']),(data[4]['x'],data[4]['y'],data[4]['rot'])],
    ...
    # k2 = 0.001
    # alfa = 10
    # item = (data[301]['x'],data[301]['y'],data[301]['rot'])
