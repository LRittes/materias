    ...
    public Calculadora() {
        ...
        botaoAdicionar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                try {
                    valores.adicionaValor(Integer.parseInt(caixaEntrada.getText()));
                    resultados.atualizar();
                    caixaEntrada.setText("");
                    caixaEntradaGeradores.setText("");
                } catch (NumberFormatException ex) {
                    JOptionPane.showMessageDialog(null, "Digite uma entrada válida!", "Erro ao ler valor",
        ...
        botaoLimpar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Não há valores a serem removidos", "Erro ao limpar",
                            JOptionPane.ERROR_MESSAGE);
                }
                resultados.atualizar();
                caixaEntrada.setText("");
                caixaEntradaGeradores.setText("");
                naturais.getSequencia().clear();
                fibonacci.getSequencia().clear();
                fatoriais.getSequencia().clear();
            }
        });
        ...
        botaoGerar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                try {
                    valores.gerar((GerarTipo) comboBox.getSelectedItem(),
                            Integer.parseInt(caixaEntradaGeradores.getText()));
                    resultados.atualizar();
                    caixaEntradaGeradores.setText("");
                    caixaEntrada.setText("");
