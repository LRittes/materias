// gcc boneco.c -lglut -lGL -lGLU -lm -o snowman && ./snowman
...
void RenderScene(void)
{
    ...
    gluCylinder(pObj, 0.14f, 0.0f, 0.3f, 26, 13);
    glPopMatrix();

    // braco esquerdo
    glColor3f(0.65f, 0.16f, 0.16f);
    glPushMatrix();
    glTranslatef(-0.30f, 0.525f, 0.0f);
    glRotatef(-90.0f, 0.0f, 1.0f, 0.0f); // Rotacionar o cilindro
    glRotatef(10.0f, 1.0f, 0.0f, 0.0f);
    gluCylinder(pObj, 0.025f, 0.025f, 0.35f, 26, 13);
    glPopMatrix();
    ...
    glTranslatef(0.30f, 0.525f, 0.0f);
    glRotatef(-90.0f, 0.0f, 1.0f, 0.0f); // Rotacionar o cilindro
    glRotatef(170.0f, 1.0f, 0.0f, 0.0f);
    gluCylinder(pObj, 0.025f, 0.025f, 0.35f, 26, 13);
    glPopMatrix();
